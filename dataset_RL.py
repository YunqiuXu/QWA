...
def get_training_game_env_multiple_levels(data_dir, difficulty_level_list, training_size, requested_infos, max_episode_steps, batch_size):
    ...
    env_id = textworld.gym.register_games(sorted(game_file_names), 
